...
## Environments
- Preview: https://main--spreadsheet-testing--lovelymandal16.hlx.page/
- Live: https://main--spreadsheet-testing--lovelymandal16.hlx.live/
...
1. Open the `spreadsheet-testing` directory in your favorite IDE and start coding :)
